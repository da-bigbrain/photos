...
const Home: NextPage = ({ images }: { images: ImageProps[] }) => {
  ...
  return (
    <>
      <Head>
        <title>Big Brain Club Photos</title>
        <meta property="og:image" content="https://enk.icu/hero.png" />
        <meta name="twitter:image" content="https://enk.icu/hero.png" />
      </Head>
        ...
        <div className="columns-1 gap-4 sm:columns-2 xl:columns-3 2xl:columns-4">
          <div className="after:content relative mb-5 flex h-[629px] flex-col items-center justify-end gap-4 overflow-hidden rounded-lg bg-white/10 px-6 pb-16 pt-64 text-center text-white shadow-highlight after:pointer-events-none after:absolute after:inset-0 after:rounded-lg after:shadow-highlight lg:pt-0">
            ...
            <h1 className="mb-4 mt-8 text-base font-bold uppercase tracking-widest">
              2024 Big Brain Club Activity Photos 📸
            </h1>
            ...
            <a
              ...
              rel="noreferrer"
            >
              Contact: dabigbrain24@gmail.com
            </a>
          </div>
      ...
      <footer className="p-6 text-center text-white/80 sm:p-12">
        ...
        <a
          href="instagram.com/deanzabigbrian"
          target="_blank"
